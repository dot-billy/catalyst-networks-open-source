...
class Tag(models.Model):
    ...
    recipe = models.CharField(max_length=32, blank=True, default='',
                              help_text='Recipe key whose rules this tag was generated from, if any.')
    recipe_answers = models.JSONField(default=dict, blank=True,
                                      help_text='Stored answers used to generate the recipe rules.')
...
class FirewallRule(models.Model):
    ...
    managed_by_recipe = models.BooleanField(default=False,
                                            help_text='True if this rule was generated by a recipe (regenerated on re-apply).')
    created_at = models.DateTimeField(auto_now_add=True)
