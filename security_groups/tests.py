...
class AssignNodesPickerTests(TestCase):
    ...
    def test_get_renders_picker_toolbar(self):
        ...
        self.assertContains(resp, ':aria-sort="sortAria(\'name\')"')
        self.assertContains(resp, ':aria-sort="sortAria(\'ip\')"')
        self.assertContains(resp, ':aria-sort="sortAria(\'type\')"')
        self.assertContains(resp, ':aria-sort="sortAria(\'assigned\')"')
        self.assertContains(resp, "sortAria(key)")
        self.assertContains(resp, "return this.sortDir === 'asc' ? 'ascending' : 'descending'")
        self.assertContains(resp, "return 'none'")
        ...
        self.assertContains(resp, "sortBy('name')")
        self.assertContains(resp, "sortBy('ip')")
        self.assertContains(resp, "sortBy('type')")
